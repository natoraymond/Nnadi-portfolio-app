...
class ContactForm extends Component {
  render() {
    ...
    return (
        <section className="contact-us-form form-tag form">
          
            <h2 className="form">Kindly Drop Your Message Here!</h2>
            <form className="contact-form form">
                ...
                <section className="contact-form-item">
                    <input className="email-input fullname-input" type="text" placeholder="Email" />
                    <br></br>
                    <label className="email-error"></label>
                </section>
                <section className="contact-form-item message">
